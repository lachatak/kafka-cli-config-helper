...
[Graph](http://127.0.0.1:5000/api/v1/kafka-acl-graph?include-pattern=boost-balance-service&exclude-topic-pattern=boost_transaction_generated_v1)

![Alt text](http://127.0.0.1:5000/api/v1/kafka-acl-graph?include-pattern=boost-balance-service&exclude-topic-pattern=boost_transaction_generated_v1)
<img src="http://127.0.0.1:5000/api/v1/kafka-acl-graph?include-pattern=boost-balance-service&exclude-topic-pattern=boost_transaction_generated_v1">
